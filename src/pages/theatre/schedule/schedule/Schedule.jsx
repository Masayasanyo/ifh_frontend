            ...
            <ul>
                    ...
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[2].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[2].thumbnail_file_path}`} alt={publishedFilm[2].title} />
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[3].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[3].thumbnail_file_path}`} alt={publishedFilm[3].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[4] && publishedFilm[5] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[4].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[4].thumbnail_file_path}`} alt={publishedFilm[4].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[5].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[5].thumbnail_file_path}`} alt={publishedFilm[5].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[6] && publishedFilm[7] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[6].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[6].thumbnail_file_path}`} alt={publishedFilm[6].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[7].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[7].thumbnail_file_path}`} alt={publishedFilm[7].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[8] && publishedFilm[9] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[8].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[8].thumbnail_file_path}`} alt={publishedFilm[8].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[9].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[9].thumbnail_file_path}`} alt={publishedFilm[9].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[10] && publishedFilm[11] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[10].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[10].thumbnail_file_path}`} alt={publishedFilm[10].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[11].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[11].thumbnail_file_path}`} alt={publishedFilm[11].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[12] && publishedFilm[13] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[12].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[12].thumbnail_file_path}`} alt={publishedFilm[12].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[13].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[13].thumbnail_file_path}`} alt={publishedFilm[13].title} />
                                <div className={styles.movieInfo}>
                ...
                {publishedFilm[14] && publishedFilm[15] && 
                    <li className={styles.day}>
                        ...
                        <div className={styles.films}>
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[14].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[14].thumbnail_file_path}`} alt={publishedFilm[14].title} />
                                <div className={styles.movieInfo}>
                            ...
                            <div className={styles.film}>
                                <img onClick={() => openFilm(publishedFilm[15].film_id)} src={`${import.meta.env.VITE_STORAGE_URL}${publishedFilm[15].thumbnail_file_path}`} alt={publishedFilm[15].title} />
                                <div className={styles.movieInfo}>
